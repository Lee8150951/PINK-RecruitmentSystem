              ...
              <el-row class="content_button">
                <el-col :span="12">
                  <button class="el-button left_button el-button--success"
                          path="/login/company_login" @click="buttonClick($event)">登录</button>
                </el-col>
                <el-col :span="12">
                  <button class="el-button right_button el-button--primary"
                          path="/register/company_register" @click="buttonClick($event)">注册</button>
                </el-col>
              </el-row>
            </div>
          </el-col>
              ...
              <el-row class="content_button">
                <el-col :span="12">
                  <button class="el-button left_button el-button--warning"
                          path="/login/admin_login" @click="buttonClick($event)">登录</button>
                </el-col>
                <el-col :span="12">
                  <button class="el-button right_button el-button--danger"
                          path="/register/admin_register" @click="buttonClick($event)">注册</button>
                </el-col>
              </el-row>
            </div>
          </el-col>
