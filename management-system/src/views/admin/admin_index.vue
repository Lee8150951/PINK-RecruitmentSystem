  ...
  data() {
    return {
      ...
      companies: [
        ...
        {
          e_name: '华为(深圳)有限公司',
          e_legalrepresentative: '任正非',
          e_establishtime: '2012-04-30',
          e_businessscope: '通讯业',
          e_logo: require('../../assets/img/company/huawei.jpg')
        },
        {
          e_name: '阿里巴巴(杭州)有限公司',
          e_legalrepresentative: '马化腾',
          e_establishtime: '2022-06-30',
          e_businessscope: '金融',
          e_logo: require('../../assets/img/company/alibaba.jpg')
        },
        {
          e_name: '字节跳动(北京)科技有限公司',
          e_legalrepresentative: '张一鸣',
          e_establishtime: '2020-09-10',
          e_businessscope: 'IT业',
          e_logo: require('../../assets/img/company/bytedance.jpg')
        },
        {
          e_name: '腾讯(深圳)科技有限公司',
          e_legalrepresentative: '马化腾',
    ...
    drawLine(){
      ...
      myChart.setOption({
        ...
        series: [
          {
            name: '用户新增',
            data: [10, 23, 41, 24, 12, 6, 20, 34, 51, 21],
            type: 'line',
            symbol: 'none',
            smooth: 0.5,
          },
